//Modulo 4 devera acrescentar duas novas funionalidade ao nosso projeto
//Exibir a data do ultimo acesso do usuario (cookies) cookies = biscoitos
//Autenticar o usuario para controlar o acesso aos recursos da aplicação
...
//durante o uso do sistema, a aplicação sabera, dentro de uma sessão valida, com quem ela se cominica.
app.use(session({
    secret:"M1nH4Ch4v3S3cR3t4",
    resave: false, //atualiza a sessão mesmo que nao ha alteração a cada requisição
...
//endpoint login que ira processar o login da aplicação
